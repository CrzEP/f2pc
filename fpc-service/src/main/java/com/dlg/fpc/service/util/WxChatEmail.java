 ...
 */
@Slf4j
public class WxChatEmail {

    public WxChatEmail(String account, String password) {
     ...
     */
    private boolean sendEmail(String fromName, String receiveMailAccount, String title, String content) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(account, fromName, "UTF-8"));
