 ...
 */
public class Win32WindowState implements WindowProc,Runnable {

    /**
     * 锁定监听
     */
    public interface OnWindowsLockListener{

        /**
         * true 锁定 false解锁
         * @param state state
         */
        void onLockState(boolean state);

        /**
         * 是否锁定
         * @return true 锁定 false解锁
         */
        boolean isLock();
    }

    @Setter
    private OnWindowsLockListener listener;
    ...
    public void run(){
        ...
        wClass.lpfnWndProc = Win32WindowState.this;
